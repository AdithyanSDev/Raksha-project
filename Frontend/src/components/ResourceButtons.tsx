...
const ResourceButtons: React.FC = () => {
  ...
  return (
    <section className="flex flex-wrap justify-center space-x-6 p-8 bg-gradient-to-r from-green-100 via-blue-50 to-green-100 shadow-md">
      <button
        className="relative bg-green-500 text-white px-8 py-4 rounded-xl shadow-lg hover:bg-green-600 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl group mb-4 sm:mb-0"
      ...
      <button
        className="relative bg-red-500 text-white px-8 py-4 rounded-xl shadow-lg hover:bg-red-600 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl group mb-4 sm:mb-0"
        onClick={handleRequestResourceClick}
      >
